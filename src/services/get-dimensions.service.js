...
export const getDimenstions = function(point) {
    if (point.z < 0) {
        return null;
    }
    ...
    if ((zx_y_angle < 0 ? zx_y_angle * -1 : zx_y_angle) > this.aperture.y) {
        return null;
    }
    if ((x_z_angle < 0 ? x_z_angle * -1 : x_z_angle) > this.aperture.zx ) {
        return null;
    }
